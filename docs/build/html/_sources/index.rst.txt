...
biosonic is a Python toolkit for advanced bioacoustic signal analysis, visualization, and feature extraction.
It provides tools for reading, processing, and visualizing animal sound recordings, with a focus on flexibility and reproducibility while staying lightweight.
...
See the :doc:`example_usage` notebook for a hands-on introduction.
